...
<body
	style="background-image: url(images/bodybackground.jpg); background-size: 100%;">
				...
				<div class="login-exterior">
					<div class="login-content">
						...
						<div class="login-interior text-center">
							<div class="login-title">培志OA系统 Login</div>
							...
							<form style="margin-top: 20px;">
								...
								<div>
									<input type="uid" class="uid-password" placeholder="工号"
										style="width: 300px;">
								</div>
								...
								<div>
									<input type="password" class="uid-password" placeholder="密码"
										style="width: 300px;">
								</div>
