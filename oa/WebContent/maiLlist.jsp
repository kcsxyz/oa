          ...
          <div class="row mt">
                  <div class="col-md-12"style="margin-top:40px;">
                      ...
                      <div class="content-panel"style="box-shadow:0px 3px 2px #fff">
                          ...
                          <!-- 上部放按钮的地方开始 -->
                          <form class="form-horizontal style-form" method="get" style="margin-top:50px;margin-bottom:40px;text-align:center;">
			                 <div class="form-group" style="border:none;margin-top:30px;">
                          	<div class="col-xs-6 col-sm-2" style="float:left;">
                          		<a href="addBulletin.jsp">
