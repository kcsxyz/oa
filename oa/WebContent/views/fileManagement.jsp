                          	...
                          	<div class="col-xs-6 col-sm-4" style="float:left;">
	                  	  	...
	                  	  	<div class="col-xs-6 col-sm-8" style="float:left;">
		                  	  	  <span style="font-weight:bold;font-size:10px;float:left;margin-right:3px;height:28px;text-align:center;line-height:28px;">创建时间：</span>
				                  	  	  <input type="text" class="form-control round-form" name="startTime" placeholder="起始时间" style="width:30%;height:28px;float:left;">
										  ...
										  -
				                  	  	  ...
				                  	  	  <input type="text" class="form-control round-form" name="startTime" placeholder="终止时间" style="width:30%;height:28px;">
	                  	  	</div>
